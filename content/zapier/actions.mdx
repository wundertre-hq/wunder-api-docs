...
Only fields you populate in the Zap are sent in the body. Updatable: `first_name`, `last_name`, `email`, `phone`, `company`, `company_id`, `job_title`, `industry`, `address_line1`, `address_line2`, `city`, `state`, `zip`, `country`, `tags`, `status`, `source`, `notes`, `linkedin_url`, `score`.
