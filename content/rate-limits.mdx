...
MCP tool calls draw from the same bucket: every `tools/call` on `/mcp` counts as one request against your 60/minute, alongside REST and Zapier polling. See the [MCP overview](/mcp/overview).
